...
mongoose
  .connect(
    "mongodb+srv://Alex:qwe@cluster0.u908xrg.mongodb.net/test?authSource=admin&replicaSet=atlas-38r5up-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true")
  .then(() => {
